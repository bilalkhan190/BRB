...
namespace BusinessObjects.Models.MetaData
{
    public class UserProfileViewModel
    {
        ...
        [Required]
        [StringLength(5, MinimumLength = 5, ErrorMessage = "Zip code should consist of 5 characters")]
        public string? ZipCode { get; set; }
        [Required]
        [StringLength(10, MinimumLength = 10, ErrorMessage = "Phone number should consist of 10 characters")]
